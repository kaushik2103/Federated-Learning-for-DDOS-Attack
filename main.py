...
# --- Configuration ---
# This path points to the final model from a 20-round training session.
# Ensure this model was generated by the 50-feature federated training process.
...
# --- Helper Function ---
def check_for_files():
    """Checks if the required model and scaler files exist."""
...
# --- SIMPLIFIED INPUT ---
# The number of inputs has been reduced to the 7 most critical features for usability.
...
# We need to know the original index of these features in the 50-feature list.
# This is based on the make_classification and pandas DataFrame creation.
feature_indices = {
    'Flow Duration': 0,
    'Total Fwd Packets': 1,
    'Total Bwd Packets': 2,
    ...
    'Flow IAT Mean': 11,
    'Average Packet Size': 38  # Assuming this is a later feature
}
...
if predict_button:
    # Create the full 50-feature input vector, initially all zeros.
    input_vector = np.zeros(NUM_FEATURES)

    # Place the user's inputs into the correct positions in the 50-feature vector.
    ...
    # 3. Explicitly convert the data to float32 before prediction.
